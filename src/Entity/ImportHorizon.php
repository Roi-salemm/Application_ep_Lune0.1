...
/**
 * Entite d'import Horizons : stocke la reponse brute et les metadonnees de requete.
 * Pourquoi: garantir une trace complete et reproductible des imports (Moon/Sun).
 * Infos: raw_header conserve la ligne d'entete CSV pour rejouer le mapping exact.
 */
...
#[ORM\Entity(repositoryClass: ImportHorizonRepository::class)]
#[ORM\Table(name: 'import_horizon')]
class ImportHorizon
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(type: Types::TEXT, nullable: true)]
    private ?string $raw_header = null;
    ...
    public function setRawHeader(?string $raw_header): static
    {
    ...
    public function setQueryParams(?array $query_params): static
    {
